...
class UserVideoPreference extends Shortcode {
	...
	public function choose_settings( int $user_id, string $room_name, array $allowed_tags = array() ): string {
		...
		// phpcs:ignore MyVideoRoomExtrasPlugin\Shortcode\bp_is_groups_component() is a Buddypress function.
		...
		$render = require __DIR__ . '/../views/shortcode-uservideopreference.php';
