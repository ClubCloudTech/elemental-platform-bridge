<?php
/**
 * Elementor_Elemental class.
 *
 * @category   Class
 * @package    Elementorelemental
...
/**
 * Main Elementor elemental Class
 *
 * The init class that runs the Elementor elemental plugin.
 ...
 */
final class Elementor_Elemental {
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-elemental' );
	}
	...
	public function init() {
		...
		require_once 'class-shortcodewidget.php';
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_Elemental ) );
...
// Instantiate Elementor_Elemental.
new Elementor_Elemental();
