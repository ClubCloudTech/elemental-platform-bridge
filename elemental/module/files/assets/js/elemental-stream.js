/**
 * Ajax control and Rendering JS for Camera and File Control Elemental.
 *
 * @package module/files/assets/js/elemental-stream copy.js
 */
  ...
  jQuery(function ($) {
    ...
    function init () {
      ...
      $('#vid-picture').click(function (e) {
        ...
        document
          .getElementById('elemental-picturedescription')
      ...
      if ($('#elemental-welcome-setup').length) {
        var existsvalue = document.getElementById(
          'elemental-welcome-setup'
        ).innerHTML
        if (existsvalue.length > 1) {
          $('.elemental-name-user').click()
          $('.elemental-app').hide()
          $('.elemental-forget-me').hide()
          $('#elemental-above-article-notification').html(
            '<br><strong>The Video Room will be available when you complete your welcome</strong>'
          )
        }
      }
    ...
    function fileUpload (event) {
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (typeof notify !== null) {
            notify.innerHTML +=
              '<br><h3>' + state_response.feedback + '</h3><br>'
          }
    ...
    function skipwindow () {
      ...
      document
        .getElementById('elemental-meeting-name')
        .classList.add('elemental-center')
    }
    ...
    var manageFile = function (event, user_id, nonce) {
        ...
        account_window = $('#elemental-welcome-page'),
        type = $('#user-add-form').attr('data-type')
      form_data.append('action', 'elemental_base_ajax')
