 ...
 *
 * @package  module/membership/views/view-forgetpassword.php
 */
                            ...
                            <div class="col-xl-8 col-lg-7 col-md-12 login">
                                <div class="login-section">
                                    ...
                                    <div class="form-container">
                                        <form id="forgotEmailForm" action="elemental_editcompany_ajax" method="post" class="form-horizontal fv-form fv-form-bootstrap ajax" novalidate="novalidate">
                                            <input type="hidden" id="token_response" name="token_response">
                                            <div class="form-group form-fg">
                                                <input type="email" name="email" id="pass_email" class="input-text" placeholder="Email Address">
