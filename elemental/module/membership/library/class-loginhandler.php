...
class LoginHandler
{
	 ...
	 * @return void
	 */
	public function render_logout_shortcode($companyDetails = array())
	{
...
?>
			...
			<a href="<?php echo esc_url($store_url); ?>" class="elemental-host-link">
				<div class="elemental-primary-nav-img" style="width:100%; background-image: url(<?php echo esc_url($store_logo); ?> )"></div>
