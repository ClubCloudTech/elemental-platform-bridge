...
class AdminTemplates {
	...
	<div id="tabCtrl">
		...
		<?php
		\ElementalPlugin\Factory::get_instance( \ElementalPlugin\Library\ShortcodeDocuments::class )->render_filtered_shortcode_docs();
		...
		<?php
		\ElementalPlugin\Factory::get_instance( \ElementalPlugin\Library\ShortcodeDocuments::class )->render_all_shortcode_docs();
