	...
	public function format_button_icon( ?string $type ): string {
		switch ( $type ) {
			...
			case 'checksound':
				...
				break;
			case 'forgetme':
				$button_label = '<span title ="' . esc_html__( 'Delete your name, picture, and clear temporary information', 'elementalplugin' ) . '" class="elemental-dashicons dashicons-dismiss"></span>';
				$button_class = 'elemental-ul-style-menu elemental-button-separation elemental-button-override';
				$a_class      = '';
